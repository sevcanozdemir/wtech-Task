...
namespace Twitter.Model.Migrations
{
    ...
    [Migration("20210523151402_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Twitter.Model.Entities.Tag", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Twitter.Model.Entities.Retweet", b =>
                {
                    b.HasOne("Twitter.Model.Entities.Tag", null)
                        .WithMany("Retweets")
                        .HasForeignKey("TagID");
            ...
            modelBuilder.Entity("Twitter.Model.Entities.Tweet", b =>
                {
                    b.HasOne("Twitter.Model.Entities.Tag", "Tag")
                        .WithMany("Tweets")
                        .HasForeignKey("TagId");
